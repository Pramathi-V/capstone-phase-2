...
# Load the CSV data
crop_df = pd.read_csv(r'D:\Capstone\capstone-phase-2\Flask\Crop_yield.csv')
weather_df = pd.read_csv(r'D:\Capstone\capstone-phase-2\Flask\combined_weather_timeline.csv')
growth_stage_df = pd.read_csv(r'D:\Capstone\capstone-phase-2\Flask\merged_growth_stages.csv')
future_weather_df = pd.read_csv(r'D:\Capstone\capstone-phase-2\Flask\2024_combined_final.csv')
